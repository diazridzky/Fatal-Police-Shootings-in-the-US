...
This project is an analysis on the data containing every fatal police shooting in the US since Jan 1st, 2015 by The Washington Post. I engineered features from the generation of the victim's age to mapping the state's real name, made several graphs for each features, and created geographical plotting for every state.
